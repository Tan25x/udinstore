    ...
    <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
            <CardHeader>
                ...
                <CardDescription>Select a preset amount or enter your details below. We include the 30% Roblox tax for you.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="rounded-lg bg-input p-4 space-y-2 text-sm">
                    ...
                    <div className="flex justify-between font-bold text-base border-t border-white/10 pt-2 mt-2">
                        ...
                        <span className='text-primary'>{gamepassPrice.toLocaleString()} R$</span>
                    </div>
                    <div className="flex justify-between font-bold text-base border-t border-white/10 pt-2 mt-2">
                        <span>You will pay:</span>
                        <span className='text-primary'>Rp {typeof totalPayment === 'number' ? totalPayment.toLocaleString('id-ID') : totalPayment}</span>
                    </div>
